  ...
  module ExtendedTrainer
    module XCResult
      ...
      class ActionTestableSummary < ActionAbstractTestSummary
        attr_accessor :project_relative_path, :target_name, :test_kind, :tests
      ...
      class ActionTestSummaryGroup < ActionTestSummaryIdentifiableObject
        attr_accessor :duration, :subtests
      ...
      class ActionTestMetadata < ActionTestSummaryIdentifiableObject
        attr_accessor :test_status, :duration, :performance_metrics_count, :failure_summaries_count, :activity_summaries_count
      ...
      class ActionSDKRecord < AbstractObject
        attr_accessor :identifier, :name, :operating_system_version
      ...
      class ActionRecord < AbstractObject
        attr_accessor :scheme_command_name, :scheme_task_name, :title, :build_result, :action_result, :run_destination
      ...
      class ActionResult < AbstractObject
        attr_accessor :result_name, :status, :issues, :timeline_ref, :log_ref, :tests_ref, :diagnostics_ref
      ...
      class DocumentLocation < AbstractObject
        attr_accessor :url, :concrete_type_name
      ...
      class IssueSummary < AbstractObject
        attr_accessor :issue_type, :message, :producing_target, :document_location_in_creating_workspace
      ...
      class ResultIssueSummaries < AbstractObject
        attr_accessor :analyzer_warning_summaries, :error_summaries, :test_failure_summaries, :warning_summaries
